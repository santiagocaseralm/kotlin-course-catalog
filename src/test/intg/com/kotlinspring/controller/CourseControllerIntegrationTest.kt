...
class CourseControllerIntegrationTest {
    ...
    fun addCourse() {
        ...
        val courseDTO =  CourseDTO(null, "Example course name", "categoryCourse", instructor.id)
    ...
    fun updateCourse() {
        ...
        val updatedCourseDTO = CourseDTO (null, "Build RestFul APIs using SpringBoot and Kotlin 1", "Development", instructor!!.id)
